                                              ...
                                              const OcsdTraceElement &elem)
{
    ...
    if(m_loggerFormatOption == CS_UI_DECOODED_FORMAT)
    {
        ...
        {
            fprintf(m_fp_decode_out, "%u,%u,%u,", 0, ((trc_chan_id & 0x7F)), (elem.context.ctxt_id_valid ? elem.context.context_id : 0));
        ...
        case OCSD_GEN_TRC_ELEM_EVENT:
        {
            if (elem.trace_event.ev_type == EVENT_TRIGGER)
                ...
                fprintf(m_fp_decode_out, "%u,Event No=%u\n", ((trc_chan_id & 0x7F)), elem.trace_event.ev_number);
        }
        break;
        case OCSD_GEN_TRC_ELEM_INSTRUMENTATION:
        {
            fprintf(m_fp_decode_out, "%u,SWITE,%u,%llu\n", ((trc_chan_id & 0x7F)), elem.sw_ite.el, elem.sw_ite.value);
        }
        break;
